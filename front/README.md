...
Фронтенд-часть интернет-магазина книг. Приложение предоставляет каталог книг, корзину, авторизацию/регистрацию, личный кабинет, историю заказов, панель управления (dashboard) и функционал заказа книг у поставщиков для пополнения склада.
